        ...
        <div className="mx-auto max-w-7xl pb-24 sm:px-6 sm:py-32 lg:px-8">
          <div className="relative isolate overflow-hidden bg-gray-400 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            ...
            <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              ...
              <p className="text-sm text-center">— MediGuard</p>
            ...
            <div className="relative mt-16 h-80 lg:mt-8">
              <img
                ...
                src="https://media.licdn.com/dms/image/C5612AQHO_ACeVM2tXg/article-cover_image-shrink_600_2000/0/1533250849628?e=2147483647&v=beta&t=uSD6u1EVxkAT74Sv5QWS2cDVu7D91l1zeV73DKdArCg"
                alt="App screenshot"
                width={200}
                height={200}
              />
